      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            color: activeTab === 'general' ? '#6b3ff7' : '#666',
            cursor: 'pointer',
            fontSize: '14px',
            fontWeight: activeTab === 'general' ? '600' : '400',
            borderBottom: activeTab === 'general' ? '2px solid #6b3ff7' : 'none',
            transition: 'all 0.2s ease',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
        ...
        <button
          ...
          style={{
            ...
            color: activeTab === 'pinnate' ? '#6b3ff7' : '#666',
            cursor: 'pointer',
            fontSize: '14px',
            fontWeight: activeTab === 'pinnate' ? '600' : '400',
            borderBottom: activeTab === 'pinnate' ? '2px solid #6b3ff7' : 'none',
            transition: 'all 0.2s ease',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
